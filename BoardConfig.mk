...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/r11s/prebuilt/Image
TARGET_PREBUILT_DTB := device/samsung/r11s/prebuilt/dtb.img
BOARD_PREBUILT_DTBOIMAGE := device/samsung/r11s/prebuilt/dtbo.img
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/r11s/bootimg.mk
